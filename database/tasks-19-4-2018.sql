...
CREATE TABLE `tasks` (
  ...
  `task_overview` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `task_description` text CHARACTER SET utf8,
  `task_slug` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `task_image` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `task_files` varchar(10000) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `tasks` (`task_id`, `user_id`, `user_email`, `user_full_name`, `category_id`, `task_name`, `task_overview`, `task_description`, `task_slug`, `task_image`, `task_files`, `task_status`, `created_at`, `updated_at`) VALUES
